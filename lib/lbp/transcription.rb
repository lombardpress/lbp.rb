...
module Lbp
	class Transcription < Resource
	  ...
	  def file(confighash=nil, branch="master")
	  ...
	  # i'd like to reverse the order of these parameters, so that file_part could be called without 
	  # indicating a config hash
	  def file_part(confighash=nil, partid)

...
describe 'transcript object' do 
	$transcript_obj1 = Lbp::Transcript.new("http://scta.info/resource/wdr-l1d1/wettf15/transcription")
	$transcript_obj2 = Lbp::Transcript.new("http://scta.info/resource/principiumIV/critical/transcription")
